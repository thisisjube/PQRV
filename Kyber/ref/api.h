...
#define kyber512_ENCCOINBYTES 32
#define kyber512_BYTES 32

int kyber512_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
int kyber512_keypair(uint8_t *pk, uint8_t *sk);
int kyber512_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
...
#define kyber768_KEYPAIRCOINBYTES 64
#define kyber768_ENCCOINBYTES 32
#define kyber768_BYTES 32

int kyber768_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
int kyber768_keypair(uint8_t *pk, uint8_t *sk);
int kyber768_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
...
#define kyber1024_KEYPAIRCOINBYTES 64
#define kyber1024_ENCCOINBYTES 32
#define kyber1024_BYTES 32

int kyber1024_keypair_derand(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
int kyber1024_keypair(uint8_t *pk, uint8_t *sk);
int kyber1024_enc_derand(uint8_t *ct, uint8_t *ss, const uint8_t *pk, const uint8_t *coins);
